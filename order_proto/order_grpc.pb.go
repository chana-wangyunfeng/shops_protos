...
type OrderClient interface {
	...
	UpdateOrder(ctx context.Context, in *UpdateOrderInfoRequest, opts ...grpc.CallOption) (*OrderEmpty, error)
}
...
func (c *orderClient) UpdateOrder(ctx context.Context, in *UpdateOrderInfoRequest, opts ...grpc.CallOption) (*OrderEmpty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderEmpty)
...
type OrderServer interface {
	...
	UpdateOrder(context.Context, *UpdateOrderInfoRequest) (*OrderEmpty, error)
...
func (UnimplementedOrderServer) UpdateOrder(context.Context, *UpdateOrderInfoRequest) (*OrderEmpty, error) {
...
func _Order_UpdateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).UpdateOrder(ctx, req.(*UpdateOrderInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
